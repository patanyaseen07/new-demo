/**
 * Fishbone RCA - Voting Phase JavaScript
 * Handles timer display, voting selection, and submission
 */
document.addEventListener('DOMContentLoaded', () => {
    ...
    window.toggleSelection = function (feedbackId, el) {
        ...
        if (el.classList.contains('selected')) {
            currentSelectedVotes.add(feedbackId);
        } else {
            currentSelectedVotes.delete(feedbackId);
        }
